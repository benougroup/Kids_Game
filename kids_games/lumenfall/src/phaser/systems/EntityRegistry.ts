...
export const MONSTER_DEFINITIONS: Record<string, EntityDefinition> = {
  ...
  dragon: {
    ...
    atlas: 'creatures',
    frames: {
      idle: 'dragon_idle_f01',
      walk: ['dragon_walk_f01', 'dragon_walk_f02', 'dragon_walk_f03'],
      run: ['dragon_fly_f01', 'dragon_fly_f02', 'dragon_fly_f03'],
      attack: 'dragon_fire_f01',
      dead: 'dragon_idle_f02',
      fainted: 'dragon_idle_f02',
      frozen: 'dragon_idle_f01',
      alert: 'dragon_fire_f01',
    },
    movementFlags: { ...DEFAULT_FLAGS, canFly: true },
    hp: 120,
    speed: 70,
