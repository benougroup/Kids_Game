...
export function createMonstersMap(): TileMap {
  ...
  const map: TileMap = {
    ...
    interactables: [
      ...
      { id: 'portal_east', type: 'door', x: width - 1, y: Math.floor(height / 2), toMapId: 'forest_south', toX: 1, toY: Math.floor(height / 2) },
